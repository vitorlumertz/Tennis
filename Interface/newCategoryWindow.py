...
def OpenNewCategoryWindow(app:"TournamentApp"):
  ...
  tk.Label(window, text="Configure a Nova Categoria", font=("Segoe UI", 28)).pack(padx=10, pady=20, anchor="w")

  tk.Label(window, text="Nome da Categoria:", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=5)
  ...
  tk.Label(window, text="Simples ou Duplas:", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=(20,5))
  ...
  tk.Label(window, text="Sortear Duplas?", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=(20,5))
  options = ['Sim', 'Não']

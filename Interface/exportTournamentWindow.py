...
def OpenExportTournamentWindow(app:"TournamentApp") -> None:
  ...
  tk.Label(window, text="Informe os dados da planilha eletrônica do Google Sheets", font=("Segoe UI", 28)).pack(padx=10, pady=20, anchor="w")

  tk.Label(window, text="Nome da planilha:", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=5)
  nameEntry = tk.Entry(window, width=50, font=('Segoe UI', 12))
  nameEntry.pack(anchor="w", padx=10)

  tk.Label(window, text="ID da pasta:", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=(20,5))
  folderIdEntry = tk.Entry(window, width=50, font=('Segoe UI', 12))
  folderIdEntry.pack(anchor="w", padx=10)

  tk.Label(window, text="Fase inicial na chave eliminatória por categoria:", font=('Segoe UI', 12)).pack(anchor="w", padx=10, pady=(20,5))
  categoriesStagesStr = tk.Entry(window, width=50, font=('Segoe UI', 12))
